...
export default function Podcast() {
  const state = [
    { title: 'Episode 1: The Nitty Gritties of Consumerism', src_mp4: 'https://mindfulconsumer-media.s3.us-east-2.amazonaws.com/episodes/Mindful_Consumer_Podcast_Ep1video.mp4', src_webm: 'https://mindfulconsumer-media.s3.us-east-2.amazonaws.com/episodes/Mindful_Consumer_Podcast_Ep1.webm' },
    { title: 'Episode 2: A Techno-social perspective', src_mp4: 'https://mindfulconsumer-media.s3.us-east-2.amazonaws.com/episodes/Mindful_Consumer_Podcast_Ep2video.mp4', src_webm: 'https://mindfulconsumer-media.s3.us-east-2.amazonaws.com/episodes/Mindful_Consumer_Podcast_Ep2.webm' },
    { title: 'Episode 3: Digital Detox', src_mp4: 'https://mindfulconsumer-media.s3.us-east-2.amazonaws.com/episodes/Mindful_Consumer_Podcast_Ep3video.mp4', src_webm: 'https://mindfulconsumer-media.s3.us-east-2.amazonaws.com/episodes/Mindful_Consumer_Podcast_Ep3.webm' }
  ]
    ...
    <div className='podcast'>
      ...
      <div className='interface'>
        ...
        <video controls className='video' key={pState.title}>
          ...
          <source src={pState.src_webm} type='video/' />
        </video>
        <div className='img-cont' onClick={() => handlePI(1)}>
